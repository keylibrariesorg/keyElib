  ...
  return (
    <>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#41974f] h-[70px]`}
      >
        <div
          ...
          <div className="flex">
            <div className={`${styles.noramlFlex}`}>
              ...
              >
                ...
                <span className="absolute right-0 top-0 rounded-full bg-[#b1ec43] w-4 h-4 top right p-0 m-0 text-white font-mono text-[12px] leading-tight text-center">
