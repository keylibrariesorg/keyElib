      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter your bok tags..."
          />
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <div>
            <input
              type="submit"
              value="Create"
              className="mt-2 cursor-pointer appearance-none text-center block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
            />
          </div>
        </div>
      </form>
